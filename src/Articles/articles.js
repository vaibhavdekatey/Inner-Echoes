...
export const featuredArticle = {
  ...
  \nIaculis metus dictum sit, vitae duis augue. Accumsan eros sem fusce laoreet feugiat. Ipsum condimentum nisl ac curae; sollicitudin efficitur? Etiam vitae fusce nibh vitae condimentum amet congue. Amet accumsan torquent semper; imperdiet aliquet aliquam magnis molestie. Arcu nunc lorem amet curabitur magnis dui volutpat velit nisi. Interdum elit nascetur ac scelerisque at?`,
};
...
export const articles = [
  ...
  \nWith its blend of emotional depth, dynamic action, and a richly developed world, "Demon Slayer" has struck a chord with both casual viewers and long-time anime fans. But what makes this series so special? Experts point to its universal themes of love, sacrifice, and perseverance, combined with groundbreaking visuals that set a new benchmark for the anime industry.`,
  },
  ...
  \nThe anime's final season has sparked heated discussions among fans, with its dramatic twists and revelations keeping everyone on the edge of their seats. Whether you love it or hate it, "Attack on Titan" has undeniably left an indelible mark on the anime landscape. What lessons can we take from its exploration of humanity's darkest and brightest moments?`,
  },
  ...
  \nWhat sets "My Hero Academia" apart is its focus on the struggles and triumphs of both heroes and villains, presenting morally gray characters that resonate deeply with audiences. Its themes of perseverance, friendship, and self-belief have inspired millions around the globe. What makes a true hero? The series continuously explores this timeless question.`,
  },
